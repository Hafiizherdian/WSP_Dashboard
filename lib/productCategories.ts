...
export const defaultProductCategories: ProductCategoryMapping = {
  ...
  'ON CALL 16 K LINE EDITION (KNG)': 'SKT',
...
export const defaultProductStickMapping: ProductStickMapping = {
  ...
  'ON BOLD 12 K': 12,
  'ON CALL 16 K (HTM)': 16,
  'ON CALL 16 K LINE EDITION (KNG)': 16,
...
export const defaultProductUnitMapping: ProductUnitMapping = {
  ...
  'ON CALL 16 K LINE EDITION (KNG)': { stickPerPack: 16, packPerSlop: 10, slopPerBal: 10, balPerDos: 6 },
